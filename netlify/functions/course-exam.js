...
const COURSE_CONTEXTS = {
  ...
  cto: { title: 'Chief Technology Officer Mastery', topics: ['The CTO Role & Technology Leadership','Technology Strategy & Architecture','Building & Leading Engineering Teams','Software Delivery & Engineering Excellence','Product & Engineering Partnership','Infrastructure, Reliability & Operations','Security, Risk & Compliance','AI, Data & Emerging Technology','Technology Finance & Vendor Management','CTO Leadership & Executive Influence'] },
  // ── EXTENDED LIBRARY ────────────────────────────────────────────────────────
