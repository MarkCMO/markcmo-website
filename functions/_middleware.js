...
const PATHS_WITH_OWN_CHROME = new Set([
  // Funnel client-flow pages are focused, self-contained, and THEMED per client
  // (warm/feminine, etc). They must NOT get the marketing nav/footer injected -
  // that chrome's CSS forces the site's dark colors over a light theme and
  // produces light-on-light text. Keep them standalone (both clean + .html).
  '/intake', '/intake.html',
  '/sign', '/sign.html',
  '/portal', '/portal.html',
]);
